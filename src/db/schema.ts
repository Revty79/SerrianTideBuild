...
export const campaignPlayers = pgTable('campaign_players', {
  ...
  uniquePair: uniqueIndex('idx_campaign_players_campaign_user_unique').on(t.campaignId, t.userId),
}));
...
export const campaignStoreItems = pgTable('campaign_store_items', {
  ...
  uniqueItem: uniqueIndex('idx_campaign_store_items_unique').on(t.campaignId, t.sourceType, t.sourceId),
}));
